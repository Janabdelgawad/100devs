...
function battle() {
    if(degree > 0) console.log('yes you can battle');
    else console.log("no you can't dumbass");
}
...
// where x is the number of pokemon the trainer you are battling 
// has in their party
for(let trainersPokemon = 5; trainersPokemon > 0; trainersPokemon--){
